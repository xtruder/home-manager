...
in {
  options.programs.i3lock = {
    ...
    text = {
      ...
      noInput = mkOption {
        description = "Text to display upon pressing backspace without anything to delete.";
        type = types.nullOr types.str;
        default = null;
      };

      lock = mkOption {
        description = "Text to display while acquiring pointer and keyboard focus.";
        type = types.nullOr types.str;
        default = null;
      };

      lockFailed = mkOption {
        description = "Text to display after failing to acquire pointer and keyboard focus.";
        type = types.nullOr types.str;
        default = null;
      };
      ...
      font = {
        ...
        wrong = mkOption {
          description = "Font use for status text upon entering incorrect password.";
          type = types.nullOr types.str;
          default = cfg.text.font.default;
        };
      ...
      size = {
        ...
        wrong = mkOption {
          description = "Text size to use for status text upon entering incorrect password.";
          type = types.nullOr types.int;
          default = cfg.text.size.default;
        };
    ...
    colors = {
      ...
      insideWrong = mkOption {
        description = "Color to use for interior circle during flash for incorrect password.";
        type = colorType;
        default = null;
      };

      ringWrong = mkOption {
        description = "Color to use for ring during flash for incorrect password.";
        type = colorType;
        default = null;
      };

      line = mkOption {
        description = "Color to use for the line separating the inside circle, and the outer ring.";
        type = colorType;
        default = null;
      };

      separator = mkOption {
        description = "Color to use for 'separator', which is at both ends of the ring highlights..";
        type = colorType;
        default = null;
      };
      ...
      wrong = mkOption {
        description = "Color to use for status text upon entering incorrect password.";
        type = colorType;
        default = null;
      };
      ...
      keyHold = mkOption {
        description = "Color to use for ring 'highlight' strokes that appear upon keypress.";
        type = colorType;
        default = null;
      };

      backspaceHold = mkOption {
        description = "Color to use for ring 'highlight' strokes that appear upon backspace.";
        type = colorType;
        default = null;
      };
    };
